...
import com.homemedics.app.databinding.FragmentWalkInHospitalMapViewBinding
...
class WalkInHospitalMapViewFragment : BaseFragment() , GoogleMap.OnCameraIdleListener {

    private lateinit var mBinding: FragmentWalkInHospitalMapViewBinding
        ...
        if (System.currentTimeMillis() > lastTextEdit + delay - 500) {
            ...
            if (activity != null && isAdded) {
                lifecycleScope.launch {
                    mMap.clear()
                    getWalkInHospitalList(displayName = search)
                }
            }
        }
    }
    ...
    override fun getFragmentLayout() = R.layout.fragment_walk_in_hospital_map_view
    ...
    override fun getViewBinding() {
        mBinding = binding as FragmentWalkInHospitalMapViewBinding
    }
    ...
    private fun setObserver() {
        walkInViewModel.walkInHospitalMapLiveData.observe(this) { walkInHospitalResponse ->
            lifecycleScope.launch {
                showLoader()
                setMap()
                delay(900)
                if(::mMap.isInitialized) {
                    hideLoader()
                    walkInHospitalResponse?.forEachIndexed{ index, walkInItem ->
                        mMap.addMarker(
                            MarkerOptions()
                        ...
                        mMap.setOnMarkerClickListener {
                            ...
                            showSelectHospitalDialog(walkInHospitalResponse[pos])
                            false
                        }
                    }
    ...
    private fun showSelectHospitalDialog(walkInItem: WalkInItemResponse) {
        builder = AlertDialog.Builder(requireActivity(), R.style.AlertDialogTheme).apply {
            ...
            setTitle(mBinding.lang?.globalString?.selectHospital.getSafe())
        ...
        builder.setOnShowListener{
            ...
            dialogSaveButton.setOnClickListener {
                ...
                walkInViewModel.hospitalId = walkInItem.id
                walkInViewModel.walkInHospitalName = walkInItem.displayName
    ...
    private fun getWalkInHospitalList(displayName: String? = null, page: Int? = null) {
                    ...
                    when(it) {
                        is ResponseResult.Success -> {
                            ...
                            (response.data as WalkInPharmacyListResponse).let { hospitalList ->
                                ...
                                if ((hospitalList.walkInHospitals?.walkInList.getSafe()).isEmpty())
                                    showToast(mBinding.lang?.globalString?.noWalkInHospital.getSafe())
                            }
                        }
