...
class LabTestsAdapter : BaseRecyclerViewAdapter<LabTestsAdapter.ViewHolder, GenericItem>(),
    Filterable {
    ...
    override fun viewHolder(view: View, viewType: Int): LabTestsAdapter.ViewHolder {
        return ViewHolder(
    ...
    inner class ViewHolder(var binding: ItemSelectAddressBinding) : BaseViewHolder<GenericItem>(binding.root) {
        override fun onBind(item: GenericItem, position: Int) {
            binding.apply {
                ...
                ivIcon.setImageResource(R.drawable.ic_bloodtype)
