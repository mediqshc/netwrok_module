...
import com.homemedics.app.databinding.FragmentCustomerReportsBinding
import com.homemedics.app.ui.adapter.EMRReportsAdapter
import com.homemedics.app.utils.*
import com.homemedics.app.viewmodel.EMRViewModel
import timber.log.Timber

class CustomerReportsFragment : BaseFragment(), View.OnClickListener {

    private lateinit var mBinding: FragmentCustomerReportsBinding
    private lateinit var listAdapter: EMRReportsAdapter
    private val emrViewModel: EMRViewModel by activityViewModels()

    override fun setLanguageData() {
        mBinding.apply {
            lang = ApplicationClass.mGlobalData
            actionbar.title = lang?.emrScreens?.reports.getSafe()
    ...
    override fun getFragmentLayout() = R.layout.fragment_customer_reports
    ...
    override fun getViewBinding() {
        mBinding = binding as FragmentCustomerReportsBinding
    }
    ...
    override fun setListeners() {
        mBinding.apply {
            ...
            ivFilter.setOnClickListener {
                findNavController().safeNavigate(CustomerReportsFragmentDirections.actionCustomerReportsFragmentToCustomerEMRFilterRecordsFragment())
            }
            ...
            listAdapter.itemClickListener = {
                ...
                if(emrViewModel.fromBDC){
                    ...
                    findNavController().safeNavigate(CustomerReportsFragmentDirections.actionCustomerReportsFragmentToCustomerReportDetailsFragment())
                }
            }
    ...
    private fun populateList() {
        mBinding.apply {
            listAdapter = EMRReportsAdapter(emrViewModel)
                ...
                when (it) {
                    is ResponseResult.Success -> {
                        ...
                        response.data?.let { emrResponse ->
                            ...
                            findNavController().safeNavigate(CustomerReportsFragmentDirections.actionCustomerReportsFragmentToAddNewReportRecordFragment())
                        }
                    }
                    is ResponseResult.Failure -> {
                        DialogUtils(requireActivity())
