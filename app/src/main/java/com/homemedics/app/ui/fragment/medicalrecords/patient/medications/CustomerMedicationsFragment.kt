...
import com.homemedics.app.databinding.FragmentCustomerMedicationsBinding
import com.homemedics.app.ui.adapter.EMRMedicationsAdapter
import com.homemedics.app.utils.*
import com.homemedics.app.viewmodel.EMRViewModel
import timber.log.Timber

class CustomerMedicationsFragment : BaseFragment(), View.OnClickListener {

    private lateinit var mBinding: FragmentCustomerMedicationsBinding
    private lateinit var listAdapter: EMRMedicationsAdapter
    private val emrViewModel: EMRViewModel by activityViewModels()

    override fun setLanguageData() {
        mBinding.apply {
            lang = ApplicationClass.mGlobalData
            actionbar.title = lang?.emrScreens?.medications.getSafe()
    ...
    override fun getFragmentLayout() = R.layout.fragment_customer_medications
    ...
    override fun getViewBinding() {
        mBinding = binding as FragmentCustomerMedicationsBinding
    }
    ...
    override fun setListeners() {
        mBinding.apply {
            ...
            ivFilter.setOnClickListener {
                findNavController().safeNavigate(CustomerMedicationsFragmentDirections.actionCustomerMedicationsFragmentToEMRMedicationsFilterFragment())
            }
            ...
            listAdapter.itemClickListener = {
                ...
                if(emrViewModel.fromBDC){
                    ...
                    findNavController().safeNavigate(CustomerMedicationsFragmentDirections.actionCustomerMedicationsFragmentToCustomerMedicationsDetailsFragment())
                }
            }
    ...
    private fun populateList() {
        mBinding.apply {
            listAdapter = EMRMedicationsAdapter(emrViewModel)
...
//                                loading = false
    ...
    private fun setupViews(){
        mBinding.apply {
            if(emrViewModel.fromBDC){
                bAddRecord.text = lang?.globalString?.add
                ...
                when (it) {
                    is ResponseResult.Success -> {
                        ...
                        response.data?.let { emrResponse ->
                            ...
                            findNavController().safeNavigate(CustomerMedicationsFragmentDirections.actionCustomerMedicationsFragmentToAddNewMedicationRecordFragment())
                        }
                    }
                    is ResponseResult.Failure -> {
                        DialogUtils(requireActivity())
